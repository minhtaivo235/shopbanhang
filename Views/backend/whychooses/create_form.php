            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form role="form" action="admin.php?controller=whychoose&action=store" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Image</label>
                                <input type="hidden" class="form-control" name="image" id="image_id"  placeholder="Image">
                                ...
                                <img class="img-preview" style="width: 200px; height: 150px;display: none" src="" alt="">
                            </div>
                            <div class="form-group">
                                <label>Content</label>
                            <textarea name="content" id="content" style="width: 100%" rows="8"></textarea>
                            </div>
