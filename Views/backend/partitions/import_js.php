...
<!-- Page level plugins -->
<script src="Public/backend/vendor/datatables/jquery.dataTables.min.js"></script>
<script src="Public/backend/vendor/datatables/dataTables.bootstrap4.min.js"></script>
