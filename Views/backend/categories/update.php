...
<head>
    <?php
    require 'Views/backend/partitions/import_css.php';
    ?>
    <title>Admin</title>
</head>
<body id="page-top">
...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    <?php
    require 'Views/backend/partitions/sidebar.php';
    ?>
    <!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container">
                <h2>Update form</h2>
                <form method="post" action="admin.php?controller=category&action=update&id=<?php echo $category['id'] ?>">


                    <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" class="form-control" name="title" id="title"
                               placeholder="Title category" value="<?php echo $category['title'] ?>">
                    </div>
                    <div class="form-group">
                        <label for="sel1">Parent</label>
                        <select class="form-control" name="parent_id">
                            <?php foreach ($optionParent as $item) { ?>
                                <?php if ($category['parent_id'] == $item['id']){?>
                                    <?php if ($item['level'] == 0) { ?>
                                        <option selected value="<?php echo $item['id'] ?>"><?php echo $item['title'] ?></option>
                                    <?php } else if ($item['level'] == 1) { ?>
    ...
    <?php
    require 'Views/backend/partitions/import_js.php';
    ?>
</div>
</body>
</html>
